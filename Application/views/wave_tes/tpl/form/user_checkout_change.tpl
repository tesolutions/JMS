                    ...
                    <div class="card-body">
                        ...
                        [{block name="user_checkout_billing_feedback"}]
                            <div class="col-lg-9 offset-lg-3" id="addressText">
                                [{include file="widget/address/billing_address.tpl" noFormSubmit=true blSubscribeNews=false blOrderRemark=true}]
                            </div>
                        [{/block}]
                    </div>
                </div>
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        [{block name="user_checkout_shipping_feedback"}]
                            [{include file="form/fieldset/order_newsletter.tpl" blSubscribeNews=false}]
