...
<html lang="[{$oView->getActiveLangAbbr()}]" [{block name="head_html_namespace"}][{/block}]>
    ...
    [{oxifcontent ident="headerhinweis" object="oCont"}]
        <div class="hinweis" style="background-color: #87B921;color:#fff;padding: 4px;margin-bottom: 3px;text-align: center;">
            [{oxcontent ident=headerhinweis}]
        </div>
    [{/oxifcontent}]
