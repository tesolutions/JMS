                            ...
                            [{block name="checkout_basketcontents_basketitem_titlenumber"}]
                                ...
                                [{block name="checkout_basketcontents_basketitem_artnum"}]
                                    <div class="small">
                                        ...
                                        [{if $basketproduct->oxarticles__ab18 == "1"}]
                                            <br><a href="/Verkauf-ab-18-Jahre/" target="_blank" title="Verkauf ab 18"><i class="fa fa-exclamation-circle" aria-hidden="true"></i> Verkauf ab 18</a>
                                        [{/if}]
                                    </div>
                                [{/block}]
