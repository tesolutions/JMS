...
[{else}]
    <a id="addToCompare[{$_compare_testid}]" class="compare add [{$_compare_class}]" data-aid="[{$_compare_aid}]" href="[{oxgetseourl ident=$oViewConf->getSelfLink()|cat:"cl="|cat:$oViewConf->getTopActiveClassName() params="am=1&amp;addcompare=1&amp;fnc=tocomparelist&aid=`$_compare_aid`&amp;anid=`$_compare_anid`&amp;pgNr=`$_compare_page`"|cat:$oViewConf->getNavUrlParams()}]"><i class="fa fa-plus-square" aria-hidden="true"></i> [{oxmultilang ident=$_compare_text_to_id}]</a>
[{/if}]
