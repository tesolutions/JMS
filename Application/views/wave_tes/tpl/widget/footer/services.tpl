[{block name="footer_services"}]
    <ul class="services list-unstyled">
        [{block name="footer_services_items"}]
            ...
            <li><a href="[{ oxgetseourl ident="de560f66ecafb7f96741002ab84b9522" type="oxcontent" }]">Öffnungszeiten</a></li>
            [{if $oViewConf->getViewThemeParam('blFooterShowHelp')}]
                <li><a href="[{$oViewConf->getHelpPageLink()}]">Hilfe zur Bedienung</a></li>
            [{/if}]
            ...
            [{/if}]
            <li><a href="[{ oxgetseourl ident="101b4ca1b58f009eb43121a1b5cd91e6" type="oxcontent" }]">Link us</a></li>
