...
[{capture name="cartTable"}]
    [{foreach from=$oxcmp_basket->getContents() name=miniBasketList item=_product}]
        [{block name="widget_minibasket_product"}]
            ...
            <div class="row minibasket-item-row">
                <div class="[{if $_prefix == 'modal'}]col-4 col-sm-2[{else}]col-3[{/if}] minibasket-item-col text-center">
                ...
                <div class="[{if $_prefix == 'modal'}]col-4 col-sm-7[{else}]col-6[{/if}] minibasket-item-col">
                    <a class="minibasket-link" href="[{$_product->getLink()}]" style="font-size: 13px;" title="[{$minibasketItemTitle|strip_tags}]">[{$minibasketItemTitle|strip_tags}]</a>

                </div>
                <div class="[{if $_prefix == 'modal'}]col-4 col-sm-3[{else}]col-3[{/if}] minibasket-item-col text-right">
    ...
    <div class="row minibasket-total-row">
        <div class="[{if $_prefix == 'modal'}]col-8 col-sm-9[{else}]col-9[{/if}] minibasket-total-col">
            <strong>[{oxmultilang ident="TOTAL"}]</strong>
        </div>
        <div class="[{if $_prefix == 'modal'}]col-4 col-sm-3[{else}]col-3[{/if}] minibasket-total-col text-right">
            <strong>
